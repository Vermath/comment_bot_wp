...
def ask_gpt4o_mini(question):
    ...
    for _ in range(3):
        response = client.chat.completions.create(
            model="ft:gpt-4o-mini-2024-07-18:raptive-nonprod:wp-commentbot-v1:A0ayrH96",
            messages=[
                {"role": "system", "content": "You are a helpful assistant for Well Plated. Your goal is to respond to comments from our users. Do not under any circumstances use proper names in your responses."},
...
def main():
    ...
    st.title("Well Plated Comment Bot")
    st.write("This is an AI-powered comment bot for www.wellplated.com. Please note that AI models can sometimes be incorrect or provide unexpected responses.")
